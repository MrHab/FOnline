...
**Карта мира.** Кнопка «КАРТА МИРА» у миникарты открывает сетку зон: цвет,
номер, открытые ворота, места и флажок там, где стоит игрок. Других игроков,
групп A-Life, патрулей и событий на ней нет — она показывает, куда идти.
...
плоское окно поверх сцены: сетка зон с цветами, номерами и флажком игрока.
