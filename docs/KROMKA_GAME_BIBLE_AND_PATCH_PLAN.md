...
> раздел 14.5, потерь — 16.5, торговли — 17.4, перемещения — 18.1, план — KRM-21.
...
| Снаряжение | только крафт игроков; конечный довоенный запас столиц на старте мира | износ, смерть в чёрной зоне (лом), разбор, «продажный» Чёрный рынок |
...
2,5%, налог с продажи — 8%, с премиумом — 4%; оба сгорают.
...
+50% марок и добычи с NPC, +50% выхода при сборе, фокус 10 000 в сутки (запас
...
отрядами на карте: после этапа 5 KRM-21 они появляются внутри сцен опасных
...
4. **Аукционы и участки.** Аукцион в каждой столице, налог и сбор, аренда
   участков через аукцион, платные станки; NPC-торговцы и NPC-станки
   выключаются; бонус Торговца базы переходит на налог.
...
**Состояние на 17.09.2026:** этапы 1 и 2 выполнены. Флаги `worldModel`
...
снаряжения, марки и узлы масштабируются по цвету зоны. Проверки:
`check:death-loot`, `check:world-model`, `check:mechanics`.
...
| Расширение живого мира | KRM-14 | причинная экономика, автономные отряды, население и видимые последствия (заменено KRM-21) |
| Экономика v3 | KRM-21 | один кран снаряжения, Чёрный рынок, аукционы, участки, опасные клетки, синь и премиум |
