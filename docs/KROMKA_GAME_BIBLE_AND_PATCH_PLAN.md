...
Сцена живёт по правилам цвета клетки, выход с края возвращает на карту в
ту же точку. Отряды NPC на карте не видны. Сквозной проход сцены каждой
клетки с выходами к соседям — следующая итерация.
...
1,6 км, отряды NPC скрыты (`check:danger-cells`); сквозной проход клеток —
следующая итерация. Этап 6: синь на счёте аккаунта, премиум с бонусами Albion,
фокус на станках и обменник синь↔марки (`check:account-sin`). Все шесть
этапов выполнены; дальше — сквозной проход опасных клеток и платёжный
магазин сини.
