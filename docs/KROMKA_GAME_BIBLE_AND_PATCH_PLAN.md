...
0,02. Пока в мире есть NPC-торговцы (до этапа 4 KRM-22), скупщик платит за
целый предмет не больше 38% базы — меньше их самой низкой цены продажи.
...
`check:world-model`, `check:black-market`, `check:mechanics`. Следующий — этап 4.
