...
и полка. Полный каталог позволяет выбрать товар и создать заявку даже при
пустой книге. Доступны поиск по названию, категории и сортировка по названию,
цене продажи или цене выкупа. Торговля идёт встречными ордерами, а не ставками.
...
и видит итоговую сумму. Пока сервер проводит операцию, повторное нажатие
не отправляет вторую сделку.
...
Книга товара показывает объём, средневзвешенную цену, минимум и максимум
