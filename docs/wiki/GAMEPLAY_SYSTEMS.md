...
T4 фиолетовый, T5 золото. Ресурсы окрашены им целиком: у каждого семейства в
`visuals` по префабу PolygonApocalypse на тир для точки добычи, сырья и
полуфабриката, а палитра заливает их цветом тира (атлас пака подменяется серой
подложкой, поэтому нет ни рисунка ковра, ни надписей). Экипировка окрашена
частично — оттенок и слабое свечение цвета тира: оружие и инструменты в руках, у
врагов и на земле, шлем на голове и все значки в интерфейсе. Надетый комплект
брони — модель персонажа целиком, её не красим. Палитру собирает «Realm of
