...
мирный (PvP отключён), синий PvE (PvP запрещён, вещи сохраняются), жёлтый PvP
(вещи сохраняются, надетое изнашивается), публичное событие (PvP разрешён,
вещи сохраняются), красный с частичной потерей (выпадает рюкзак, экипировка и
установленные артефакты остаются) и чёрный — Сердцевина, где выпадает всё, а
часть выпавшего становится ломом. Правила зоны видны до входа: и при прибытии с глобальной
...
ремонт, разбор и оружейные модули. Торговля с торговцем столицы или игроком
...
марки (в поле дешевле верстак: там платят ремкомплектом или рудой с древесиной
и собственным навыком). Оба работают только рядом с собой и только в мирном
поселении, поэтому в бой не вмешиваются.

Аукционер открывает не диалог, а отдельный экран рынка. **У каждой столицы
своя книга ордеров** (экономика v3): ордер, выставленный в одной столице, в
другой не виден, товар везут ногами, а членство во фракции для торговли не
нужно. На
экране — категории товаров со счётчиками, книга по каждому предмету,
...
выставлении. Ордер живёт выбранный срок — сутки, трое суток, неделю или месяц; товар
...
Станки поселений — участки (экономика v3): право аренды на неделю
разыгрывается на торгах в окне станка, арендатор назначает плату за заказ и
получает её, сам работает бесплатно; на свободном участке платят поселению, и
эти марки сгорают. Станок участка возвращает часть материалов — 15%, в
профильном регионе столицы 25%.

Синь — валюта аккаунта (экономика v3): она лежит на счёте, не в рюкзаке, и
не выпадает. За 300 сини покупается премиум на 30 дней: налог аукциона 4%,
+50% опыта, марок с NPC и добычи при сборе, работы базы быстрее и фокус для
возврата материалов на станках участков. Синь и марки меняются между
...
крафта Пип-Боя; остаток фокуса виден там же и на странице персонажа.

Глобальная карта окрашена по опасности (экономика v3): мирные столицы,
синие пояса, жёлтая земля, красные внешние регионы и чёрная Сердцевина. На
жёлтой, красной и чёрной земле путь может оборваться стычкой — сервер
переносит отряд в общую сцену участка 1,6 км, где встречаются все, кого
застало там же, со стороны, откуда отряд пришёл. Чёрную Сердцевину по карте
не пройти: каждая её клетка — сцена, выход с края ведёт в соседнюю клетку, а
в обычную землю — на карту у общей границы. Цвета опасности и их правила
объясняет легенда в окне карты.

Угрозы опасных земель живут сами (A-Life): стаи гари, слухачи, плакальщики,
рыхляки, складни, выжженные и банды налётчиков обитают у своих логов, бродят
по окрестностям и приходят на шум в соседние сцены — с того края, откуда
шли, о чём игрок получает предупреждение. Убитые не возвращаются, стая с
большими потерями отступает, а логово восполняет её медленно и только без
игроков рядом. Стычка в пути — встреча с настоящей группой поблизости.

Что видно на глобальной карте, решает «Странник»: чем он выше, тем дальше
игрок замечает группы монстров и налётчиков и других игроков (от 4 до 14 км),
а высокий «Странник» другого игрока прячет его — такого видно только вблизи.
Клетки Сердцевины пронумерованы («Разбитый тракт №47»): номер виден на
карте, в заголовке миникарты и в окне «КАРТА МИРА», которое открывается
кнопкой на миникарте и показывает флажком, где стоит игрок.
