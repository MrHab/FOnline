...
видны до входа: и при прибытии с глобальной карты, и на переходе внутри мира.
...
чёрную зону и на публичное событие Unity показывает отдельное подтверждение.
...
группового кланового маршрута либо защищённый сбор. Особые заказы списывают ресурсы и
...
Глобальная карта окрашена по опасности: мирные столицы, синие пояса, жёлтая
земля, красные внешние регионы и чёрная Сердцевина. На жёлтой, красной и чёрной
земле путь может оборваться стычкой — сервер переносит отряд в общую сцену
участка 1,6 км, где встречаются все, кого застало там же, со стороны, откуда
отряд пришёл. Чёрную Сердцевину по карте
...
Угрозы опасных земель живут сами (A-Life, `src/server/danger-ecology.js`):
стаи гари, выводки пыльников, слухачи, рыхляки, плакальщики, складни,
выжженные, стада фонарников и банды налётчиков обитают у своих логов, бродят
...
Чёрный рынок, аукционы столиц, опасные клетки с A-Life и счета аккаунта;
симуляция ведёт контроль и конфликты точек, мировые задания и пополнение полок
торговцев. Выключены потребление и производство поселений, население с
беженцами, караваны, станки NPC без аренды, снаряжение с трупов NPC и отряды
NPC на глобальной карте: код сохранён и возвращается теми же флагами. Сдвиг
