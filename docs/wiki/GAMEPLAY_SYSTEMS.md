...
- У каждой лаборатории своя угроза зала. Шкала копится сама, на пике сервер
  объявляет удар, а через несколько секунд он бьёт по части секторов —
  остальные остаются проходом. Узлы на стенах сбрасывают шкалу, уходят в
  ...
  охранной машины (пока питание идёт, машина неуязвима), «Сплав» жжёт давлением и
...
- Детектор говорит о находке до подбора: Mk1 — только сила сигнала, Mk2
  добавляет тир в цвете общей шкалы, Mk3 называет и вид. Кнопка подбора у Mk3
  сразу пишет, что именно лежит под ногами.
...
и потерь; встречи приходят к идущему — пока отряд не прошёл по области свою
долю пути, проверка не делается, — а приходят они по-разному — стая бродит поодаль, поджидает
