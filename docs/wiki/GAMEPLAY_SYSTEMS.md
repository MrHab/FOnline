...
- Верхом ход тот же, что пешком (WASD относительно камеры, стик на телефоне), но
  со скоростью транспорта — 11 м/с, примерно вдвое быстрее бега, — с разгоном и
  торможением; присесть нельзя. Бонусы скорости артефактов и травмы ног на
  мотоцикл не действуют.
- Как и пеший персонаж, мотоцикл поворачивается к курсору мыши (520°/с; над
  самим мотоциклом курсор его не вертит). Едет он туда, куда ведут WASD: задним
  ходом колёса крутятся назад, боком мотоцикл сносит. На телефоне мыши нет — там
  он разворачивается по ходу движения.
