...
Мир — 197 зон по 20 км на сетке 19 × 15, их собирает конструктор. По миру
ходят пешком: у зоны на открытых сторонах ворота в соседние зоны, шаг в проход
переводит в соседнюю зону. Места — поселения, базы, логова — стоят внутри зон,
в них входят через портал, а золотая полоса по краю места выводит обратно в
его зону. Публичные события, бои отрядов и следы угодий стоят в зонах
...
кнопкой «КАРТА» на телефоне. Оно рисует сетку зон: цвет опасности, номер,
закрытые стороны стеной, места и столицы, а флажком — где стоит игрок (в месте —
в зоне, куда выводит его край). Зона под курсором называется внизу окна. Других
...
(«Срединная жила №148»); имя с номером видно и в заголовке миникарты.
