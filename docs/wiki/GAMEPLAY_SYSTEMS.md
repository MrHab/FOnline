...
- Аномалии рождают артефакты сами: одна проверка в минуту на свободное поле,
  ...
  вид зависит от типа аномалии, тир — от пояса поля. Неподобранные находки
  обновляются следующим выбросом.
...
разрешено, вещи сохраняются, спорный сундук и задержка возврата после смерти)
