...
Аукционер базы открывает не диалог, а отдельный экран торгов: категории товаров
со счётчиками, лоты своей фракции, свои лоты, форма выставления и полка. Лот
выставляется на один из предложенных сервером сроков (6, 12, 24 или 48 ч) со
стартовой ценой и необязательной ценой выкупа. Ставка снимает марки сразу — их
держит сам лот, перебитая ставка целиком возвращается прежнему претенденту на
полку, а ставка в последние две минуты продлевает торги. Продажа по выкупу или
по концу срока удерживает налог на продажу (5%), предмет уходит победителю на
полку, и снять лот, на который уже поставили, нельзя. Всё купленное, выигранное
и возвращённое забирается у аукционера в пределах места и грузоподъёмности.
