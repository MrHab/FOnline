...
Аукционер открывает не диалог, а отдельный экран рынка. **Книга ордеров одна на
всю пустошь**: ордер, выставленный в одной столице, виден и исполняется у
любого другого аукционера, а членство во фракции для торговли не нужно. На
