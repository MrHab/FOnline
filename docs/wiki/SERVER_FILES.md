...
| `wasteland-party-speed.js` | чистые профили, минимумы, пределы и миграционная нормализация скорости мировых отрядов |
| `wasteland-party-membership.js` | нормализация состава отрядов, лимиты, patrol duty и сверка с авторитетными персонажами |
...
| `coalesced-writer.js` | single-flight таймер для объединения частых некритичных JSON-записей с немедленным flush критических изменений |
