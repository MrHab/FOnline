...
(async () => {
  ...
  const GAME_CLIENT_VERSION = '7.76.6-service-scout-boots-5';
  window.REALM_GAME_RUNTIME_VERSION = GAME_CLIENT_VERSION;
  ...
  const GAME_SCRIPT_PARTS = [
    ...
    '/js/game/04b_service_scout_boots_runtime.js',
  ...
  try {
    ...
    window.REALM_GAME_RUNTIME_PARTS = scriptParts.length;
