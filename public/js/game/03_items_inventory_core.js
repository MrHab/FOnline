  ...
  const SPECIAL_STAT_DEFS_FALLBACK = [
    ...
    { key: 'luck', code: 'LK', name: 'Удача', desc: 'Проверки удачи, травмы, добыча и второй шанс.' }
  ];
