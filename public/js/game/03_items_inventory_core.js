  ...
  const CRAFT_RECIPES = [
    ...
    { id: 'medicinecraft', name: 'Медикаменты', icon: '🌿', out: { id: 'medicine', qty: 3 }, cost: { chemicals: 2, water: 1 }, desc: 'Базовое медицинское сырьё из химикатов и воды. Нужно для стимуляторов, аптечек и антибиотиков.' },
