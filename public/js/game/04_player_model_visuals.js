  ...
  const TALENTS = [
    ...
    { id: 'specialLuck', icon: '🍀', name: 'Удача +1', group: 'SPECIAL', max: 3, req: { level: 3 }, desc: '+1 к Удаче за каждый ранг: выше точность, взлом, шанс Второго шанса, добыча ресурсов и ниже риск перелома или контузии.' }
  ];
