...
/**
 * Экономика v3 (библия 14.5, 16.5, KRM-22): переключатели механик и числа
 * лестницы зон. Все значения читаются из `data/kromka/economy.json`;
 * отсутствующее поле берёт значение по умолчанию, а незнакомое отбрасывается,
 * поэтому старый файл не ломает сервер. Потребление поселений, производство
 * NPC, караваны и отряды NPC на карте сняты совсем и флагов не имеют.
 */
