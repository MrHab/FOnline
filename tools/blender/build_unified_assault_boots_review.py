...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--asset-id", default="equipment_assault_boots_unified_v1")
...
def combine_boot_objects(
    ...
    boots["realm_item_id"] = "assaultBoots"
...
def main() -> None:
    ...
    materials = {
        "leather": BASE.pbr_material("assault_boots_olive_leather", (0.082, 0.092, 0.058), 0.82, 0.0),
        "sole": BASE.pbr_material("assault_boots_black_sole", (0.045, 0.050, 0.048), 0.88, 0.0),
        "canvas": BASE.pbr_material("assault_boots_olive_webbing", (0.078, 0.086, 0.050), 0.92, 0.0),
        "hardware": BASE.pbr_material("assault_boots_bright_hardware", (0.220, 0.235, 0.228), 0.40, 0.80),
        "steel": BASE.pbr_material("assault_boots_graphite_composite", (0.060, 0.070, 0.066), 0.58, 0.30),
        "rust": BASE.pbr_material("assault_boots_black_polymer", (0.020, 0.024, 0.023), 0.70, 0.0),
    }
    ...
    print("REALM_UNIFIED_ASSAULT_BOOTS_V1=" + json.dumps(report, ensure_ascii=False, sort_keys=True))
