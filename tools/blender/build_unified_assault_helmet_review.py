...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--asset-id", default="equipment_assault_helmet_unified_v1")
...
def assault_visor_material() -> bpy.types.Material:
    ...
    material.name = "assault_helmet_laminated_amber_visor"
...
def build_assault_details(
    ...
    for point in (
        brow[1].lerp(brow[2], 0.35),
        cheek_panels[0][4].lerp(cheek_panels[0][5], 0.50),
        rear[4].lerp(rear[5], 0.42),
    ):
        builder.surface_patch(point + Vector((0, -0.002, 0)), Vector((0, -1, 0)), 0.0055, 1)
    ...
    details["realm_item_id"] = "assaultHelmet"
    details["realm_item_name_ru"] = "Штурмовой шлем"
...
def main() -> None:
    ...
    materials = [
        BASE.pbr_material("assault_helmet_weathered_graphite_composite", (0.060, 0.070, 0.066), 0.68, 0.16, args.body_id, 0.19),
        BASE.pbr_material("assault_helmet_exposed_laminate_edge", (0.255, 0.215, 0.135), 0.80, 0.06, args.body_id, 0.17),
        BASE.pbr_material("assault_helmet_aged_black_polymer", (0.018, 0.022, 0.021), 0.73, 0.0, args.body_id, 0.14),
        BASE.pbr_material("assault_helmet_dusty_retention_webbing", (0.070, 0.062, 0.044), 0.92, 0.0, args.body_id, 0.20),
        BASE.pbr_material("assault_helmet_tarnished_hardware", (0.175, 0.190, 0.182), 0.49, 0.76, args.body_id, 0.11),
    ...
    helmet["realm_item_id"] = "assaultHelmet"
    ...
    print("REALM_UNIFIED_ASSAULT_HELMET_V1=" + json.dumps(report, ensure_ascii=False, sort_keys=True))
