...
const context = {
  SERVER_FACTION_STORAGE_IDS: new Set(['old_klim', 'scrap_union', 'relay_order']),
  ...
  locationCapitalFaction: value => ({ settlement: 'old_klim', scrapTown: 'scrap_union', relayStation: 'relay_order' })[String(value || '')] || ''
};
...
console.log('Faction storage check passed: three isolated capital storages with legacy migration.');
