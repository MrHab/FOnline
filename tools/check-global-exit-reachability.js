#!/usr/bin/env node
'use strict';
// Достижимость края мест: полоса у края места выводит в его зону мира.
//
// Главный игровой вопрос: может ли персонаж ДОЙТИ от точки спавна до полосы
// выхода пешком. Стена из авторских объектов,
