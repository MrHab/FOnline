...
namespace Kromka.EditorTools
{
    ...
    /// The strategic-map authoring passes may still provide a fallback material
    /// for procedural geometry and textureless models, but textured kit assets
    /// must not be flattened to a single replacement colour.
    /// </summary>
    internal static class KromkaGlobalMapNativeModelMaterialAuthoring
    {
        ...
        internal static void ValidateSourceAtlases()
        {
            RequireTexture(CarTexture, "Kenney Car Kit 3.1");
            RequireTexture(FactoryTexture, "Kenney Factory Kit 3.0");
            RequireTexture(CityTexture, "Kenney City Kit Industrial 2.0");
        }
