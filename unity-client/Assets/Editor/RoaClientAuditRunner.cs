...
namespace RealmOfAshes.EditorTools
{
    ...
    public static class RoaClientAuditRunner
    {
        private static readonly Type[] Probes =
        {
            ...
            // Вход, регистрация и выбор персонажа — первое, что видит игрок: тот же экран,
            // те же размеры и проверки, плюс длинная ошибка сервера и длинный список.
            ...
            typeof(RoaFrozenBoneProbe),
            typeof(RoaRadioProbe),
            typeof(RoaNetworkActorMotionProbe),
            typeof(RoaOfflineResilienceProbe),
            typeof(RoaEnemyThreatTelegraphProbe),
            typeof(RoaNpcCombatBehaviorProbe),
            typeof(RoaNpcCombatCoordinationProbe),
            typeof(RoaSettlementLifeProbe),
            typeof(RoaJourneyFlowProbe),
            typeof(RoaMissionDirectorProbe),
            typeof(RoaEncounterLayoutProbe),
