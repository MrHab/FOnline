...
namespace RealmOfAshes.Game
{
    ...
    public sealed class RoaMapWindowCanvas : MonoBehaviour
    {
        ...
        private void Update()
        {
            // Закрываемся только когда bootstrap отключает ввод (меню, кат-сцена).
            // BlocksWorldHud сюда нельзя: он учитывает и это окно —
        ...
        public void Open()
        {
            // Карта локации — окно: терминал и карта мира при этом закрываются.
