    ...
    public static class RoaProgressionData
    {
        ...
        private static string SkillDescription(string id)
        {
            switch (id)
            {
                ...
                case "wanderer": return "Находки, добыча ресурсов, встречи и скорость движения по глобальной карте; дальше видит на карте группы и игроков и сам заметен хуже.";
