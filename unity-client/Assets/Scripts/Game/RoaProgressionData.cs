    ...
    public static class RoaProgressionData
    {
        ...
        private static string TalentDescription(string id)
        {
            switch (id)
            {
                ...
                case "merchant": return "+8% к цене продажи и +3 п.п. к скидке покупки за каждый ранг.";
                case "diplomat": return "+8 п.п. к проверкам диалога и +8% к наградам квестов за каждый ранг.";
                case "scrounger": return "Останки снаряжения с убитых вами людей: +15% деталей и лома за ранг.";
                case "cacheSense": return "Первым открыв тайник, находите в нём на 25% больше материалов за ранг; награды боссов и событий не растут.";
